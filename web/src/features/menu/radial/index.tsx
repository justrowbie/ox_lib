...
const useStyles = createStyles((theme) => ({
  ...
  sector: {
    fill: theme.colors.dark[5] + 'E6',
    color: theme.colors.gray[0],
    transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
    stroke: 'transparent',
    strokeWidth: 1.5,
    '&:hover': {
      fill: theme.colors[theme.primaryColor][5] + 'CC',
      stroke: theme.colors[theme.primaryColor][5] + 'CC',
      strokeWidth: 1.5,
      '& g > svg > path': {
        fill: theme.colors.dark[5] + 'E6',
      },
  ...
  centerIcon: {
    color: theme.colors[theme.primaryColor][5] + 'CC',
    '&:hover': {
      color: theme.colors[theme.primaryColor][5] + 'CC',
    },
  },
  closeIcon: {
    color: theme.colors.gray[0] + 'E6',
    opacity: 0.9,
    pointerEvents: 'none',
